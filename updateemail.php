...
if($count>0){
    echo "<div class='alert alert-danger'>There is already an user registered with that email! Please choose another one!</div>"; exit;
}
...
$message .= "http://harishjhaldiyal.thecompletewebhosting.com/notes-app/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
